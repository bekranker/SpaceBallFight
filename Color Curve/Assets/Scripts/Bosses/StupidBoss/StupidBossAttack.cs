...
public class StupidBossAttack : MonoBehaviour
{
    ...
    private WaitForSecondsRealtime _sleep = new WaitForSecondsRealtime(1.1f);
    ...
    {
        _t.DOMove(new Vector2(_startPosition.x, _Positions[_positionIndex].y + _startPosition.y), 1.5f);
        yield return _sleep;
